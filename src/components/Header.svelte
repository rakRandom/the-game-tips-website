    ...
    <nav class="md:max-w-[1024px] h-full mx-auto py-2 w-full">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                <ul
                    class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-[#69D3C9] rounded-lg bg-[#001219] AAAAAAAFDF] md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
                    <li>
                        <a href="/"
                            class="block py-2 px-3 text-white t AAAAAAA rounded hover:bg-[#69D3C9] md:hover:bg-transparent md:hover:text-[#69D3C9] md:p-0">Home</a>
                    </li>
                    <li>
                        <a href="/#/about"
                            class="block py-2 px-3 text-white t AAAAAAA rounded hover:bg-[#69D3C9] md:hover:bg-transparent md:hover:text-[#69D3C9] md:p-0">About Us</a>
                    </li>
                    <li>
                        <a href="/#/help"
                            class="block py-2 px-3 text-white t AAAAAAA rounded hover:bg-[#69D3C9] md:hover:bg-transparent md:hover:text-[#69D3C9] md:p-0">Help</a>
                    </li>
                </ul>
            </div>
